...
let reptiles = [
    new Animal("Reptiles", 
        ...
        "Northern  Austalia", 
        "The-Frilled-Lizard.jpeg",
        "frill-lizard.png"),

    new Animal("Reptiles", 
        "Hawksbill Turtle", 50, 80, 50, 
        "sponges, jellyfish, seaplants", 
    ...
    new Animal("Reptiles", "Perentie", 250, 20, 20, 
        "Carnivore, animals like kangaroos, rabbits, lizards and birds",
...
let birds = [
    ...
    new Animal("Birds", 
        "Kookaburra", 43, 0.003, 20, 
        "Insects and smalll animals including snakes, frogs, lizards",
    ...
    new Animal("Birds", 
        "Yellow Tailed Black Cockatoo",  65, 0.9, 41, 
        "Fruit, seeds, plant",
        ...
        "SE Austalia", 
        "Yellow-tailed_Black_Cockatoos.jpg",
        "cockatoo.png")
];
